...
| Tag(s) | Major.Minor Release | Current Version |
| :----- | ------------------- | --------------- |
| `beta`, `beta-6.3`, `beta-6.3.0.43` | `6.3.x` Beta | `6.3.0.43` |
| `beta-openj9`, `beta-6.3-openj9`, `beta-6.3.0.43-openj9` | `6.3.x` Beta w/OpenJ9 | `6.3.0.43` |
...
| `UPGRADE_ES_HTTPS_PORT` | `8044` | `1024`-`65535` | Dedicated HTTPS port for upgrades for ES series devices | >= `6.3.0.36` |
